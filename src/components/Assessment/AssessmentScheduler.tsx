    ...
    <div className="h-full flex flex-col">
      ...
      <div className="mb-6">
        ...
        <select
          ...
          className="w-full px-4 py-2.5 bg-[#252526] text-white border border-white/10 rounded-lg focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 font-geist text-sm"
        >
      ...
      {selectedPeriod && validDateRange && (
        <div className="mb-6 p-4 bg-[#252526] border border-white/10 rounded-lg">
          <h3 className="text-sm font-semibold text-white mb-3 font-geist flex items-center gap-2">
      ...
      {selectedPeriod ? (
        ...
        <div className="flex-1 flex items-center justify-center text-neutral-500">
          <div className="text-center">
            ...
            <p className="text-sm font-geist">Silakan pilih periode assessment terlebih dahulu</p>
            <p className="text-xs font-geist text-neutral-600 mt-1">
