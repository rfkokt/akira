...
pub async fn install_skill(
    ...
    let description = fs::read_to_string(&skill_md_path).ok().and_then(|content| {
        content
            .lines()
...
pub fn uninstall_skill(state: State<AppState>, skill_id: String) -> Result<(), String> {
    ...
    let skill_path: String = conn
        .query_row(
            "SELECT skill_path FROM skills WHERE id = ?1",
            [&skill_id],
            |row| row.get(0),
        )
...
pub async fn fetch_marketplace_skills(
    ...
    let popular_skills = vec![
        ...
        (
            ...
            "skills",
            "skill-creator",
            "Create new skills from existing code",
        ),
        ...
        (
            ...
            "skills",
            "find-skills",
            "Discover and install agent skills from the skills.sh marketplace",
        ),
        ...
        (
            ...
            "agent-skills",
            "supabase-postgres-best-practices",
            "Postgres performance optimization from Supabase",
        ),
        ...
        (
            ...
            "superpowers",
            "writing-plans",
            "Write comprehensive development plans",
        ),
        (
            "executing-plans",
            "obra",
            "superpowers",
            "executing-plans",
            "Execute development plans effectively",
        ),
        (
            ...
            "superpowers",
            "requesting-code-review",
            "Request and handle code reviews",
        ),
        (
            ...
            "superpowers",
            "receiving-code-review",
            "Receive and act on code review feedback",
        ),
        ...
        (
            ...
            "skills",
            "building-native-ui",
            "Build native UI components with Expo",
        ),
        (
            ...
            "skills",
            "native-data-fetching",
            "Data fetching patterns for Expo",
        ),
        ...
        (
            ...
            "skills",
            "remotion-best-practices",
            "Remotion video creation best practices",
        ),
        ...
        (
            ...
            "skills",
            "vue",
            "Vue.js best practices from Anthony Fu",
        ),
    ];
    ...
    let filtered: Vec<MarketplaceSkill> = if let Some(ref q) = query {
        ...
        popular_skills
            ...
            .take(limit)
            .map(
                |(name, owner, repo, skill_path, description)| MarketplaceSkill {
                    name: name.to_string(),
